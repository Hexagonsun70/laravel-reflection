    ...
    <section class="flex flex-col items-center m-4">
        <div class="flex flex-col justify-center items-center bg-gray-800 rounded-xl mb-2">
            ...
            <div class="mb-8 mt-2 capitalize">
                <a href="companies/all/table" class="font-bold tracking-wider p-2 bg-green-400 text-white rounded h-auto mr-2 mt-2">
                    Companies Table
                </a>
...
{{--                                <?php $replaceArr = [',',' '] ?>--}}
{{--                                <a href="/companies/{{  strtolower(str_replace($replaceArr, '-', $company->name))  }}">--}}
